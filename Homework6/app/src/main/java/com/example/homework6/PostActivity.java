...
//        Log.d("DEBUG", mPost.getAuthor());
        ...
        image6.setImageResource(mPost.getImageId(5));
        image7.setImageResource(mPost.getImageId(6));
        image8.setImageResource(mPost.getImageId(7));
        image9.setImageResource(mPost.getImageId(8));
    }
}